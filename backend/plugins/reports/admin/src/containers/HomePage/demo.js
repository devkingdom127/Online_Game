    ...
    return (
      <Paper>
        <Chart data={chartData} className={classes.chart}>
          ...
          <LineSeries name="Users" valueField="tvNews" argumentField="year" />
          <LineSeries name="Orders" valueField="church" argumentField="year" />
          <Legend
            position="bottom"
            rootComponent={Root}
            itemComponent={Item}
          ...
          />
          <Title text={`User and Orders Report`} textComponent={TitleText} />
          <Animation />
        </Chart>
      </Paper>
    );
